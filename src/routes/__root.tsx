...
export const Route = createRootRouteWithContext<RouterContext>()({
  head: () => ({
    meta: [
      ...
      { title: "KRISNApedia" },
      { name: "description", content: "KRISNApedia — Knowledge Management System for KRISNA (Planning and Budgeting Information System)" },
      { name: "author", content: "KRISNApedia" },
      { property: "og:title", content: "KRISNApedia" },
      { property: "og:description", content: "KRISNApedia — Knowledge Management System for KRISNA (Planning and Budgeting Information System)" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "KRISNApedia" },
      { name: "twitter:description", content: "KRISNApedia — Knowledge Management System for KRISNA (Planning and Budgeting Information System)" },
